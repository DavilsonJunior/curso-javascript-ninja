...
var name = ['D','A','V','I','L','S','O','N'];
var nameReduzido = name.reduce(function(acumulado, atual, index){
    if(index === 0) {
        acumulado = 'P';
    }
    return acumulado + 'P' +atual;
});
console.log( nameReduzido );
/*
...
console.log( Array.isArray( justMod2Or3 ) ? JSON.stringify( justMod2Or3 ) : justMod2Or3 );
