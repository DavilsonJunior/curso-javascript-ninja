...
var myName = text.replace(/Manuel Marques de Sousa/, 'Davilson Paulino da Cunha Junior')
console.log( myName );
...
console.log( myName.replace(/brasileiro/g, 'Sao carlense') );
...
console.log( myName.replace(/\d/g, '-') )
...
console.log( myName.replace(/[D-Hd-h]/gi, '0') );
...
console.log( text.replace(/(O Centauro de Luvas)/, 'O Centauro de Luvas'.toUpperCase()) );
...
function getMonthNumber(  months ) {
    var meses = {
        janeiro:'01',
        fevereiro:'02',
        'março':'03',
